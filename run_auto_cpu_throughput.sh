...
${NUMA_OPERATOR} bash run_workload.sh ${EXAMPLE_NAME} IPEX_OPTION $precision $bs

export NUMA_OPERATOR="numactl --cpunodebind=0 --membind=0"
export EXAMPLE_NAME="text-classification"
export MODEL_NAME="bert-base-cased"
export TASK_NAME="mrpc"
${NUMA_OPERATOR} bash run_workload.sh ${EXAMPLE_NAME} IPEX_OPTION $precision $bs JIT bert

export NUMA_OPERATOR="numactl --cpunodebind=0 --membind=0"
export EXAMPLE_NAME="text-classification"
export MODEL_NAME="bert-base-cased"
export TASK_NAME="mrpc"
${NUMA_OPERATOR} bash run_workload.sh ${EXAMPLE_NAME} IPEX_OPTION $precision $bs JIT_OPT bert
...
export MODEL_NAME="distilbert-base-cased"
export TASK_NAME="cola"
${NUMA_OPERATOR} bash run_workload.sh ${EXAMPLE_NAME} IPEX_OPTION $precision $bs JIT distilbert

export NUMA_OPERATOR="numactl --cpunodebind=0 --membind=0"
export EXAMPLE_NAME="text-classification"
export MODEL_NAME="distilbert-base-cased"
export TASK_NAME="cola"
${NUMA_OPERATOR} bash run_workload.sh ${EXAMPLE_NAME} IPEX_OPTION $precision $bs JIT_OPT distilbert
...
export MODEL_NAME="bert-large-cased"
export TASK_NAME=""
${NUMA_OPERATOR} bash run_workload.sh ${EXAMPLE_NAME} IPEX_OPTION $precision $bs JIT qa_models

export NUMA_OPERATOR="numactl --cpunodebind=0 --membind=0"
export EXAMPLE_NAME="question-answering"
export MODEL_NAME="bert-large-cased"
export TASK_NAME=""
${NUMA_OPERATOR} bash run_workload.sh ${EXAMPLE_NAME} IPEX_OPTION $precision $bs JIT_OPT qa_models
